...
// Complete contact page with clickable cards and proper icons
            ...
            {profile?.email && (
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ color: '#007bff', fontSize: '0.9rem' }}>{profile.email}</div>
                </div>
              </a>
            )}
            ...
            {profile?.phone && (
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ color: '#28a745', fontSize: '0.9rem' }}>{profile.phone}</div>
                </div>
              </a>
            )}
              ...
              <div style={{ marginTop: '2rem' }}>
                ...
                {profile.socialLinks?.github && (
                  <a
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.target.style.transform = 'scale(1.02)';
                      e.target.style.boxShadow = '0 4px 15px rgba(51,51,51,0.2)';
                    }}
                    onMouseLeave={(e) => {
                      e.target.style.background = '#f8f9fa';
                      e.target.style.transform = 'scale(1)';
                ...
                {profile.socialLinks?.linkedin && (
                  <a
                    ...
                    onMouseEnter={(e) => {
                      e.target.style.background = '#e3f2fd';
                      e.target.style.transform = 'scale(1.02)';
                      e.target.style.boxShadow = '0 4px 15px rgba(0,119,181,0.2)';
                    }}
                    onMouseLeave={(e) => {
                      e.target.style.background = '#f8f9fa';
                      e.target.style.transform = 'scale(1)';
                ...
                {profile.socialLinks?.twitter && (
                  <a
                    ...
                    onMouseEnter={(e) => {
                      e.target.style.background = '#e3f3fd';
                      e.target.style.transform = 'scale(1.02)';
                      e.target.style.boxShadow = '0 4px 15px rgba(29,161,242,0.2)';
                    }}
                    onMouseLeave={(e) => {
                      e.target.style.background = '#f8f9fa';
                      e.target.style.transform = 'scale(1)';
                ...
                {profile.socialLinks?.instagram && (
                  <a
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.target.style.transform = 'scale(1.02)';
                      e.target.style.boxShadow = '0 4px 15px rgba(220,39,67,0.2)';
                    }}
                    onMouseLeave={(e) => {
                      e.target.style.background = '#f8f9fa';
                      e.target.style.transform = 'scale(1)';
